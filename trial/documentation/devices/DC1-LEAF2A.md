...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.26.113/24 | 192.168.26.1 |
...
| -------------- | --------------- | ------------------------- | -------------- | -------------- | ---------- | -------- | ------ |
| gzip | 192.168.26.126:9910 | magickey | ale,flexCounter,hardware,kni,pulse,strata | /Sysdb/cell/1/agent,/Sysdb/cell/2/agent | MGMT | MGMT | False |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet1 | routed | - | 172.16.10.3/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 120.0.0.3/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 110.0.0.3/32 |
...
| -------- | --------- | --- |
| 120.0.0.1 | 65001 | default |
| 172.16.10.2 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
router bgp 65102
   ...
   neighbor 172.16.10.2 description DC1-SPINE1_Ethernet1
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 120.0.0.0/24 eq 32 |
| 20 | permit 110.0.0.0/24 eq 32 |
